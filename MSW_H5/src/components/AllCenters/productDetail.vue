  ...
  <div>
    ...
    <div class="infodiv">
      ...
      <div class="two_title">
        ...
        <div class="two_title_right">卖家承诺发货时间 : <span style="color:#ff0000"> 1~{{parseInt(produstInfo.dailyCapacity)}}m²,{{parseInt(produstInfo.cycle)}}天内发货</span>
        </div>
      </div>
    ...
    methods: {
      ...
      getInfo () {
        ...
        this.$http.post('/goodsdetails/info', qs.stringify(_data)).then(({data}) => {
          ...
          this.sellGoodsTypeName = (data.data[2])[0].goodsTypeName;
