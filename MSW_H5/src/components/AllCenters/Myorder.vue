      ...
      <scroller lock-x ref="scrollerBottom" @on-scroll-bottom="ajaxGet()" height="-104px" :scroll-bottom-offst="200">
        <div>
          <ul class="Ul">
              ...
              <div class="Li_header">
                  <p style="font-size: 14px">商家店铺： {{index.shopName}} <span style="color:#fe9005;float:right"  v-if="orderStatus=='0'">待付款</span>
                      ...
                      <span  style="color:#fe9005;float:right"    v-if="orderStatus=='5'">订单完成</span></p>
            ...
            <div class="Li_header_phone">
                  <div class="borderss">
                      ...
                      <img src="@/assets/img/phone.png" alt="">工厂</a>
                    </div>
                     <div class="borderss fr" style="border:1px solid #ff0000;color:#ff0000" @click="pay(index.id)">
                     去付款
                </div>
...
<script>
  ...
  export default {
    ...
    mounted () {
      this.getOrder(this.clonePage, 0);
...
.Li_header_phone{ width: 100%;height: 6vw;line-height: 6vw;padding: 2vw 0}
  .Myorder_title ul li {
    height: 8vw;
    line-height: 7vw;
    padding: 1vw 0;
...
.Li_header_img{ width: 100%;padding: 3vw 0 ;border-top: 1px solid #f1f1f1;overflow: hidden;}
.Li_header_img_left{ width: 25vw;height: 25vw;float: left;}
.Li_header_img_left img{ width: 25vw;height: 25vw; }
