  ...
  <div id="layout" :style="bodyH">
    ...
    <tabbar class="indexTabbar" v-if="this.$store.state.Tabbar">
      <tabbar-item link="/index">
        ...
        <span v-if="Selected==0?true:false" slot="label" style="color: #00b2ff">首页</span>
        <span v-else slot="label" style="color: #666">首页</span>
      </tabbar-item>
      <tabbar-item link="/shop">
        ...
        <span v-if="Selected==1?true:false" slot="label" style="color: #00b2ff">工厂</span>
        <span v-else slot="label" style="color: #666">工厂</span>
      </tabbar-item>
    ...
    <div class="productBottom" v-else-if="this.$store.state.pruductbar">
      <router-link to="/shop">
        <div class="bardiv">
      ...
      <router-link to="/car">
        <div class="bardiv">
          ...
          <badge :text="carNumber" v-if="carNumber>=1"></badge>
          <p>购物车</p>
        </div>
      </router-link>
